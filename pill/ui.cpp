...
void Initialize_UI(HINSTANCE mod) {
	...
	HWND hwnd = CreateWindowEx(0, L"RelifePill", L"Osu-Relife v0.5 by hq.af <github.com/hq-af>", WS_EX_PALETTEWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 400, 275, prnt_hWnd, NULL, inj_hModule, NULL);
